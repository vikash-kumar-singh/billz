...
public class PackingSelectionAdapter extends RecyclerView.Adapter<PackingSelectionAdapter.ViewHolder> {
    private final List<PackingFee> fees;
    private final OnClickListener listener;
    private int selectedId = -1;

    public interface OnClickListener { void onClick(PackingFee fee); }

    public PackingSelectionAdapter(List<PackingFee> fees, OnClickListener listener) {
        this.fees = fees;
