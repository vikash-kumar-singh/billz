...
public class DeliverySelectionAdapter extends RecyclerView.Adapter<DeliverySelectionAdapter.ViewHolder> {
    private final List<DeliveryFee> fees;
    private final OnClickListener listener;
    private int selectedId = -1;

    public interface OnClickListener { void onClick(DeliveryFee fee); }

    public DeliverySelectionAdapter(List<DeliveryFee> fees, OnClickListener listener) {
        this.fees = fees;
